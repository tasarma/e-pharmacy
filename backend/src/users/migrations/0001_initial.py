    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gln_number', models.CharField(blank=True, max_length=13, null=True)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['tenant', 'email'], name='idx_tenant_email'),
        ),
        migrations.AddConstraint(
            model_name='customuser',
            constraint=tenants.models.UniqueTenantConstraint(fields=('tenant', 'email'), name='unique_tenant_email'),
        ),
        migrations.AddConstraint(
            model_name='userprofile',
            constraint=tenants.models.UniqueTenantConstraint(fields=('tenant', 'user'), name='unique_tenant_user_profile'),
        ),
        migrations.AddConstraint(
            model_name='userprofile',
            constraint=tenants.models.UniqueTenantConstraint(fields=('tenant', 'gln_number'), name='unique_tenant_gln'),
        ),
    ]
