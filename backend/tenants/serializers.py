...
class TenantSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'tenant', 'store_name', 'store_description',
            ...
            'allow_guest_checkout', 'require_email_verification',
            'maintenance_mode',
...
class TenantOnboardingSerializer(serializers.Serializer):
    ...
    store_name = serializers.CharField(
        max_length=200,
        required=False,
        help_text="If not provided, uses tenant_name"
    )
    ...
    store_email = serializers.EmailField(
        required=False,
        help_text="Public store email (defaults to manager_email)"
    )
    ...
    def create(self, validated_data: Dict[str, Any]) -> Tenant:
        ...
        store_settings = {
            'store_name': validated_data.pop('store_name', validated_data['tenant_name']),
