...
class TestTenantAwareAuthentication:
    ...
    def test_authenticate_user_in_different_tenant(self, manager, other_tenant, request_factory):
    ...
    def test_authenticate_same_email_different_tenants(self, tenant, other_tenant, request_factory):
